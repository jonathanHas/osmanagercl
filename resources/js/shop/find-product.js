...
export default () => {
    ...
    return mix(base, {
        ...
        /**
         * `hasImage()` and the `failed` map come from productImages(). This screen
         * extends the failure handler, because an image that dies while it is
         * enlarged or being previewed must take those states down with it.
         */
        imageFailed(p) {
            base.imageFailed.call(this, p);
