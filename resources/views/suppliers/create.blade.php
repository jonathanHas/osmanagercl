                        ...
                        <div>
                            ...
                            <select name="vat_treatment" id="vat_treatment"
                                ...
                                @foreach($vatTreatments as $value => $label)
                                    <option value="{{ $value }}" {{ old('vat_treatment') === $value ? 'selected' : '' }}>
                                        {{ $label }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div>
                            ...
                            <select name="default_purchase_use"
                                ...
                                @foreach($purchaseUses as $value => $label)
                                    <option value="{{ $value }}" {{ old('default_purchase_use', 'resale') === $value ? 'selected' : '' }}>
                                        {{ $label }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div>
                            ...
                            <select name="rtd_classification"
                                ...
                                @foreach($rtdClassifications as $value => $label)
                                    <option value="{{ $value }}" {{ old('rtd_classification', 'not_applicable') === $value ? 'selected' : '' }}>
                                        {{ $label }}
                                    </option>
                                @endforeach
                            </select>
