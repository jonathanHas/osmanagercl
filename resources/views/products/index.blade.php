<x-admin-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <x-filter-form 
                ...
                <x-slot:searchAction>
                    <button type="button" onclick="openProductScannerModal()"
    ...
    <div id="product-scanner-modal" class="fixed inset-0 bg-black bg-opacity-50 z-50 hidden" x-data="productSearchScanner()" x-show="modalOpen" @keydown.escape="closeModal()">
        <div class="flex items-center justify-center min-h-screen p-4">
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-xl max-w-md w-full" @click.away="closeModal()">
                <div class="p-6">
                    <div class="flex justify-between items-center mb-4">
                    ...
                    <div id="product-search-scanner-camera" class="rounded-lg overflow-hidden bg-gray-900" style="min-height: 260px;"></div>
    ...
    @push('scripts')
        ...
        <script>
            function openProductScannerModal() {
            ...
            function productSearchScanner() {
                return {
                    ...
                    openModal() {
                        this.modalOpen = true;
                        this.$nextTick(() => this.startScannerCamera());
                    },
                    ...
                    onScannerDetected(text) {
                        ...
                        url.searchParams.set('search', parsed.barcode.trim());
