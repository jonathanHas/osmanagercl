<x-admin-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                {{ __('Manage Coffee Products') }}
            </h2>
            <a href="{{ route('coffee.index') }}" class="text-amber-600 hover:text-amber-800">
                ← Back to Dashboard
            </a>
        </div>
    </x-slot>

    <div class="py-6" x-data="coffeeManagementSystem()">
            ...
            <div class="bg-white rounded-lg shadow mb-6 p-6">
                ...
                <div class="mt-4 flex items-center justify-between">
                    <div class="text-sm text-gray-600">
                        ...
                        <span x-show="searching" class="text-amber-600">Searching...</span>
            ...
            <div class="bg-white rounded-lg shadow overflow-hidden">
                <div class="overflow-x-auto">
                                ...
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-3 py-4">
                                        <div class="w-10 h-10 rounded-lg overflow-hidden bg-amber-100 flex items-center justify-center">
                                            <img :src="'/coffee/product-image/' + product.CODE" 
                                                 :alt="product.NAME"
                                                 class="w-full h-full object-cover"
                                                 @@error="$el.style.display='none'; $el.nextElementSibling.style.display='flex'">
                                            <div class="hidden w-full h-full items-center justify-center text-amber-600 text-xs">
                                    ...
                                    <!-- Product Info -->
                                    <td class="px-4 py-4">
                                        <a :href="'/products/' + product.ID + '?from=coffee'"
                                        ...
                                        <div class="text-xs text-gray-400" x-text="product.category?.NAME || 'Coffee Fresh'"></div>
                                        ...
                                        <div x-data="{ 
                                            ...
                                            <div x-show="editing" x-cloak class="mt-1">
                                                <input type="text" 
                                                       ...
                                                       class="w-full text-xs border-gray-300 rounded focus:ring-amber-500 focus:border-amber-500">
                                            </div>
                                        </div>
                                    </td>
                                        ...
                                        <div x-data="{ 
                                            ...
                                            <div x-show="editing" x-cloak class="flex items-center gap-1">
                                                ...
                                                <input type="number" 
                                                       ...
                                                       class="w-20 text-sm border-gray-300 rounded focus:ring-amber-500 focus:border-amber-500">
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <!-- Actions -->
                                    <td class="px-4 py-4 text-center">
                                        <a :href="'/coffee/sales?search=' + encodeURIComponent(product.NAME)" 
                    ...
                    <div x-show="!searching && products.length === 0" class="text-center py-12">
                        ...
                        <h3 class="mt-2 text-sm font-medium text-gray-900">No coffee products found</h3>
    ...
    @push('scripts')
    <script>
        function coffeeManagementSystem() {
            return {
                ...
                async performSearch() {
                    ...
                    try {
                        ...
                        const response = await fetch('{{ route('coffee.products') }}?' + params, {
                            headers: {
                ...
                async toggleProductAvailability(productCode, isAvailable) {
                    try {
                        ...
                        const response = await fetch('{{ route('coffee.visibility.toggle') }}', {
                            method: 'POST',
                            headers: {
