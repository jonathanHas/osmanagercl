                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="text-center">
                        ...
                        <p class="mt-2 text-gray-600 dark:text-gray-400">
                            You have successfully accessed the manager-only page.
                        </p>
                        <p class="mt-4 text-sm text-gray-500 dark:text-gray-500">
                            This page requires the <code class="bg-gray-100 dark:bg-gray-700 px-2 py-1 rounded">manager</code> or <code class="bg-gray-100 dark:bg-gray-700 px-2 py-1 rounded">admin</code> role.
                        </p>
