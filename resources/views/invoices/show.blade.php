    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-1 space-y-6">
                ...
                {{-- RTD Link for Udea invoices --}}
                @if($invoice->isUdeaSupplier())
                <div class="bg-gray-800 rounded-lg p-4">
                    <a href="{{ route('rtd.index') }}"
                       class="flex items-center justify-between text-gray-300 hover:text-white transition">
                        <div class="flex items-center">
                            ...
                            <span>RTD Management</span>
                            @if($invoice->rtd_status === 'frozen')
                                <span class="ml-2 px-2 py-0.5 text-xs rounded bg-green-900 text-green-300">Frozen</span>
                            @elseif($invoice->hasRtdData())
                                <span class="ml-2 px-2 py-0.5 text-xs rounded bg-blue-900 text-blue-300">Computed</span>
                            @endif
                        </div>
