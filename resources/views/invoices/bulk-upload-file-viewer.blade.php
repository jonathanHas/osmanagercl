<x-admin-layout>
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div class="flex justify-between items-center mb-6">
            <h2 class="text-2xl font-bold text-gray-100">View Uploaded File</h2>
            <div class="flex space-x-2">
                ...
                <a href="{{ route('invoices.bulk-upload.preview', $batch->batch_id) }}" 
        ...
        <div class="bg-gray-800 rounded-lg p-4 mb-6">
            <div class="flex items-center space-x-4">
                ...
                <div>
                    <h3 class="text-lg font-semibold text-gray-100">{{ $file->original_filename }}</h3>
                    <p class="text-sm text-gray-400">
                        Batch Upload • {{ $file->formatted_file_size }} • 
                    ...
                    <p class="text-sm">
                        ...
                        @if($file->supplier_detected)
                            <span class="ml-2 text-xs text-gray-400">[{{ $file->supplier_detected }}]</span>
                        @endif
                    </p>
                </div>
            </div>
