                                ...
                                <tr class="hover:bg-gray-50" id="row-{{ $suggestion->product_code }}">
                                    ...
                                    <td class="px-3 py-3 text-center">
                                        @if($productModel)
                                            <button
                                                type="button"
                                                class="restock-btn inline-flex items-center px-3 py-1.5 bg-green-600 text-white text-xs font-medium rounded-md hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 transition-colors"
