<x-admin-layout>
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div class="flex justify-between items-center mb-6">
            <h2 class="text-2xl font-bold text-gray-100">View Document</h2>
            <div class="flex space-x-2">
                ...
                <a href="{{ route('deliveries.show', $document->delivery_id) }}"
        ...
        <div class="bg-gray-800 rounded-lg p-4 mb-6">
            <div class="flex items-center space-x-4">
                ...
                <div>
                    <h3 class="text-lg font-semibold text-gray-100">{{ $document->original_filename }}</h3>
                    <p class="text-sm text-gray-400">
                        {{ $document->document_type_label }} &bull; {{ $document->formatted_file_size }} &bull;
