                                        ...
                                        <tr class="hover:bg-gray-50">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <div class="text-sm text-gray-900">
                                                    {{ $snapshot->valuation_date->format('d M Y') }}
                                                </div>
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-right">
                                                <div class="text-sm font-medium {{ $snapshot->adjusted_total ? 'text-blue-600' : 'text-gray-900' }}">
                                                    {{ number_format($snapshot->final_total, 2) }}
                                                </div>
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <div class="text-sm text-gray-500">
                                                    {{ $snapshot->creator?->name ?? 'System' }}
                                                </div>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                ...
                                                @if($snapshot->canBeModified())
                                                    <form action="{{ route('management.stock-valuation.destroy', $snapshot) }}"
                                                          method="POST"
                                                          class="inline"
                    ...
                    @else
                        <div class="text-center py-8">
                            ...
                            <p class="mt-1 text-sm text-gray-500">
                                Get started by viewing live valuation or creating a snapshot.
                            </p>
