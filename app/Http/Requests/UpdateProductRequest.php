...
class UpdateProductRequest extends FormRequest
{
    ...
    {
        return true; // Allow authenticated users to update products
    }
    ...
    {
        return [
            // Basic Information - code is required but must be unique excluding current product
            'name' => 'required|string|max:255',
            'code' => [
                'required',
                'string',
                'max:50',
                Rule::unique('pos.PRODUCTS', 'CODE')->ignore($this->route('id'), 'ID'),
            ],
            ...
            // Stock Information (not required for updates)
