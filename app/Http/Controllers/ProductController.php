...
class ProductController extends Controller
{
    ...
    /**
     * The barcode generator service instance.
     */
    ...
    {
        return $this->barcodeGenerator->nextForConfiguredCategory($categoryId);
    }
    ...
    {
        return $this->barcodeGenerator->isCodeInRange($code, $ranges);
    }
    ...
    {
        return $this->barcodeGenerator->nextGeneric();
    }
