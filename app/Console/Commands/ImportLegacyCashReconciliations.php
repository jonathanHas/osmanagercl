        ...
        $this->withProgressBar($records, function ($record) use (
            ...
            try {
                ...
                $reconciliation = new CashReconciliation([
                    ...
                    'cash_50c' => $record->cash50c ? (int) round($record->cash50c / 0.5) : 0,
                    'cash_20c' => $record->cash20c ? (int) round($record->cash20c / 0.2) : 0,
                    'cash_10c' => $record->cash10c ? (int) round($record->cash10c / 0.1) : 0,
