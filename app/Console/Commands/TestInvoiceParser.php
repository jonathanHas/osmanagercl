        ...
        if ($file && $checks['all_checks_passed']) {
            ...
            if ($result['success']) {
                ...
                if (!empty($data['vat_breakdown'])) {
                    ...
                    if ($vat['vat_0'] > 0) $this->line('  0%: €' . number_format($vat['vat_0'], 2));
                    if ($vat['vat_9'] > 0) $this->line('  9%: €' . number_format($vat['vat_9'], 2));
                    if ($vat['vat_13_5'] > 0) $this->line('  13.5%: €' . number_format($vat['vat_13_5'], 2));
                    if ($vat['vat_23'] > 0) $this->line('  23%: €' . number_format($vat['vat_23'], 2));
                }
