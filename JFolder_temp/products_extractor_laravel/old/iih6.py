...
class IIHInvoiceParser:
    ...
    def generate_report(self, all_rows: List[Dict], output_base: str):
        ...
        report_lines = []
        report_lines.append("# IIH Invoice Parsing Report (v6)")
...
def main():
    parser = argparse.ArgumentParser(description='IIH Invoice Parser v6 - Fixed price validation for mixed case/unit scenarios')
    parser.add_argument('path', nargs='?', default='.', help='Path to PDF file or directory (default: current directory)')
    parser.add_argument('-o', '--output', default='iih6_output', help='Output filename base (default: iih6_output)')
