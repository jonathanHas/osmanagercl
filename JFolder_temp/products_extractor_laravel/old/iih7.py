...
class IIHInvoiceParser:
    ...
    def generate_report(self, all_rows: List[Dict], output_base: str):
        ...
        report_lines = []
        report_lines.append("# IIH Invoice Parsing Report (v7)")
...
def main():
    parser = argparse.ArgumentParser(description='IIH Invoice Parser v7 - Enhanced warnings with product codes')
    parser.add_argument('path', nargs='?', default='.', help='Path to PDF file or directory (default: current directory)')
    parser.add_argument('-o', '--output', default='iih7_output', help='Output filename base (default: iih7_output)')
